...
import rsl_rl
from rsl_rl.algorithms import PPO, Distillation, PPOLIP
...
class OnPolicyRunnerLip:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        if self.alg_cfg["class_name"] == "PPO" or self.alg_cfg["class_name"] == "PPOLIP":
        ...
        self.alg: PPO | Distillation | PPOLIP = alg_class(policy, device=self.device, **self.alg_cfg, multi_gpu_cfg=self.multi_gpu_cfg)
        ...
        if self.empirical_normalization:
            if resumed_training:
                ...
                if "privileged_obs_norm_state_dict" in loaded_dict:
                    ...
                    self.privileged_obs_normalizer.load_state_dict(loaded_dict["critic_obs_norm_state_dict"])
            else:
