...
from . import agents, flat_env_cfg, rough_env_cfg, QP_env_cfg
...
gym.register(
    id="Isaac-Velocity-QP-Unitree-Go1-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": QP_env_cfg.UnitreeGo1QPEnvCfg,
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:UnitreeGo1QPPPORunnerCfg",
    },
)
