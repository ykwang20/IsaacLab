...
if TYPE_CHECKING:
    from .contact_ground_sensor_z_cfg import ContactGroundSensorZCfg


class ContactGroundSensorZ(SensorBase):
    ...
    cfg: ContactGroundSensorZCfg
    """The configuration parameters."""

    def __init__(self, cfg: ContactGroundSensorZCfg):
    ...
    def _initialize_impl(self):
        ...
        if self.cfg.track_air_time:
            ...
            [False] * self._num_envs, device=self._device, dtype=torch.bool
        )
    ...
    def _update_buffers_impl(self, env_ids: Sequence[int]):
        ...
        if self.cfg.track_air_time:
            ...
            upper_contact= torch.any(self._data.net_forces_w[env_ids, self.cfg.activation_contact_body_ids, 2] > self.cfg.force_threshold, dim=1)
            lower_detach = torch.any(self._data.net_forces_w[env_ids, self.cfg.activation_detach_body_ids, 2] < self.cfg.force_threshold, dim=1)
            ...
            is_contact = self._data.force_matrix_w[env_ids, :,0, 2] > self.cfg.force_threshold
