...
class ContactSensorZ(SensorBase):
    ...
    cfg: ContactSensorZCfg
    """The configuration parameters."""

    def __init__(self, cfg: ContactSensorZCfg):
    ...
    def _update_buffers_impl(self, env_ids: Sequence[int]):
        ...
        if self.cfg.track_air_time:
            ...
            is_contact = self._data.net_forces_w[env_ids, :, 2] > self.cfg.force_threshold
