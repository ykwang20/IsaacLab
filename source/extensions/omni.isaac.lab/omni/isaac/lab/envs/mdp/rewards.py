...
def contact_forces_exp(env: ManagerBasedRLEnv, threshold: float, sensor_cfg: SceneEntityCfg) -> torch.Tensor:
    ...
    rew=torch.exp(0.0025*(max_contact-threshold).clip(min=0.0))-1
    #print("VIOLATION: ", rew)
