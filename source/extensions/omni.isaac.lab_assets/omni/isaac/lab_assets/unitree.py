...
G1_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        #collision_props=sim_utils.CollisionPropertiesCfg(contact_offset=0.02, rest_offset=-0.02),
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.74),
        joint_pos={
...
G1_29_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="source/asset/g1/g1_29dof.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
G1_29_ANNEAL_23_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="source/asset/g1/g1_29dof_anneal_23dof.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
G1_29_MODIFIED_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            # "left_shoulder_pitch_joint": 0.75,#-0.35,
            # "right_shoulder_roll_joint": -0.2,
            # "right_shoulder_pitch_joint": 0.75,#-0.35,
...
G1_29_MODIFIED_714_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="source/asset/g1/g1_29dof_modified_new.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
