...
G1_29_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/workspace/isaaclab/source/asset/g1/g1_29dof_feetmod.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
G1_29_MINIMAL_CFG.spawn.usd_path = "/workspace/isaaclab/source/asset/g1/g1_29dof_feetmod_minimal.usd"
G1_29_MODIFIED_CFG = G1_29_CFG.copy()
# TODO: change usd
G1_29_MODIFIED_CFG.spawn.usd_path = "/workspace/isaaclab/source/asset/g1/g1_29dof_modified.usd"