...
class FailureClassifierLearner:
    def __init__(self, cfg:dict):
        ...
        self.load(path='failure_classifier_5keys.pt')
        scripted=torch.jit.script(self.classifier)
        scripted.save('failure_classifier_5keys_scripted.pt')
...
class ClassifierLearnerCfg:
    ...
    encoder_path = "./logs/VAE_16dims/model_3keys_latent16.pt"
    eval_pct = 0.25
    logger = "wandb" #"tensorboard"
    wandb_project = "failure_classifier_16dim"
    log_dir = "./logs/Tune_failure_3keys_16dim"  # base log directory
    save_interval = 50
    eval_interval = 2
    batch_size = 64
    ...
    oversample_ratio = 1.0 #9.0  # How much to oversample minority class (for 'oversample' and 'combined')
